...
| № п/п | Наименование элемента | Тип элемента | Назначение элемента | Описание, комментарии, ограничения |
|----|:----:|----|----|----|
| 1 | Начать | *Кнопка* | *По нажатию происходит открытие тестирования* |  |
| 2 | Вернуться к просмотру вакансии | *Кнопка* | *По нажатию происходит возврат на страницу с информацией о вакансии"* |  |
